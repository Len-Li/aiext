export const translations = {
  "zh-CN": {
    ...
    "overlay_analyze_paper_btn": "解读论文",
    "overlay_translate_btn": "翻译本页",
    ...
    "overlay_analyzing_paper": "正在解读论文，请稍候…",
    "overlay_analyze_paper_done": "论文解读完成，可以继续提问。",
    "overlay_translating": "正在翻译当前网页，请稍候…",
    "overlay_translate_done": "翻译完成，可以继续提问。",
    "overlay_thinking": "正在思考，请稍候…",
    "overlay_replied": "已回复，你可以继续提问。",
    "overlay_call_fail": "调用失败：",
    "overlay_ask_analyze": "请帮我解读当前网页内容。",
    "overlay_ask_analyze_paper": "请帮我解读这篇论文。",
    "overlay_ask_translate": "请帮我翻译当前网页内容。",
    
    // Background Prompts
    "prompt_system": "你是一个帮助用户用简体中文解释网页内容的助手，需要用通俗、分点的方式总结重点。",
    "prompt_paper_system": "你是一个擅长解读学术论文的助手。请使用简体中文，保留必要的英文术语与指标名称，优先讲清研究问题、核心方法、实验设计、结果结论、局限性；不要编造论文中没有明确出现的信息，不确定时请直接说明。",
    "prompt_translate_system": "你是一个高质量网页翻译助手。请将页面内容翻译为简体中文，忠实原文，不随意省略关键信息；术语、人名、产品名、公式、代码、链接文字尽量保留原意，必要时在中文后保留原文括注。",
    "prompt_user_intro": "请你阅读下面网页内容，并完成：",
    "prompt_paper_user_intro": "请你把下面内容当作论文或论文页面来解读，并按以下结构输出：\n1）先用 3-5 条说明论文研究什么问题、要解决什么痛点、核心贡献是什么\n2）概括论文的方法思路：模型/算法框架、关键模块、输入输出、训练或推理方式\n3）提取实验部分的关键信息：数据集、评价指标、主要对比对象、最重要的结果\n4）指出论文结论成立所依赖的前提、作者提到或你能从正文明确归纳出的局限性\n5）如果页面内容不像论文正文，请明确说明，并尽量根据已有内容给出保守解读\n6）最后分析这篇文章能带来什么启发，有哪些未解决的问题，以及三行以内总结",
    "prompt_translate_user_intro": "请你将下面网页内容翻译成简体中文，并按以下要求输出：\n1）优先完整翻译标题和正文主要内容\n2）保持原文结构，适当分段，便于阅读\n3）专业术语、人名、缩写可保留原文并在首次出现时补充中文说明\n4）如果内容过长，先完整翻译最重要部分，其余部分做准确概述并明确说明\n5）不要额外分析，不要总结，不要改写成立场性表达",
  ...
  "en-US": {
    ...
    "overlay_analyze_paper_btn": "Analyze Paper",
    "overlay_translate_btn": "Translate Page",
    ...
    "overlay_analyzing_paper": "Analyzing the paper, please wait...",
    "overlay_analyze_paper_done": "Paper analysis complete. You can continue asking questions.",
    "overlay_translating": "Translating the current page, please wait...",
    "overlay_translate_done": "Translation complete. You can continue asking questions.",
    ...
    "overlay_ask_analyze_paper": "Please help me understand this paper.",
    "overlay_ask_translate": "Please translate this page for me.",

    // Background Prompts
    "prompt_system": "You are a helpful assistant that summarizes web content in English. Please be concise and use bullet points.",
    "prompt_paper_system": "You are an assistant specialized in interpreting academic papers. Respond in the user's language when possible, preserve important technical terms and metric names, focus on the research question, core method, experimental setup, results, and limitations, and never invent details that are not clearly supported by the page.",
    "prompt_translate_system": "You are a high-quality web translation assistant. Translate the page content faithfully into Simplified Chinese, preserve key information, and keep technical terms, names, formulas, code, and link text accurate. When helpful, keep the original term in parentheses after the Chinese translation.",
    "prompt_user_intro": "Please read the following web content and:",
    "prompt_paper_user_intro": "Please interpret the following content as a research paper or paper page, and structure your answer as follows:\n1) Explain the problem, motivation, and main contributions in 3-5 bullets\n2) Summarize the method: model/algorithm, key modules, inputs/outputs, and training or inference setup\n3) Extract the most important experimental details: datasets, metrics, baselines, and headline results\n4) Point out the assumptions and limitations that are explicitly stated or can be conservatively inferred from the page\n5) If the page does not look like an actual paper body, say so clearly and provide a cautious interpretation based only on the available content\n6) End with a short judgment on whether the paper is worth reading in depth, plus a summary within 3 lines",
    "prompt_translate_user_intro": "Please translate the following web page content into Simplified Chinese and follow these rules:\n1) Translate the title and the main body as completely as possible\n2) Preserve the original structure and split into readable paragraphs\n3) Keep technical terms, names, and abbreviations accurate; you may keep the original term when it helps clarity\n4) If the content is too long, fully translate the most important parts and clearly mark the rest as an accurate condensed translation\n5) Do not add extra analysis, summary, or opinion",
  ...
  "ja-JP": {
    ...
    "overlay_analyze_paper_btn": "論文を解説",
    "overlay_translate_btn": "このページを翻訳",
    ...
    "overlay_analyzing_paper": "論文を解説中、お待ちください…",
    "overlay_analyze_paper_done": "論文の解説が完了しました。質問を続けられます。",
    "overlay_translating": "現在のページを翻訳中、お待ちください…",
    "overlay_translate_done": "翻訳が完了しました。質問を続けられます。",
    ...
    "overlay_ask_analyze_paper": "この論文を解説してください。",
    "overlay_ask_translate": "このページを翻訳してください。",
    
    // バックグラウンドプロンプト
    "prompt_system": "あなたは日本語でウェブコンテンツを説明するアシスタントです。分かりやすく、箇条書きで要点をまとめてください。",
    "prompt_paper_system": "あなたは学術論文の解説を得意とするアシスタントです。必要な英語の専門用語や指標名は残しつつ、研究課題、主要な手法、実験設計、結果、限界を中心に説明し、本文で確認できない内容は推測で断定しないでください。",
    "prompt_translate_system": "あなたは高品質なウェブ翻訳アシスタントです。ページ内容を簡体字中国語に忠実に翻訳し、重要情報を省略せず、専門用語、人名、数式、コード、リンク文言の意味を正確に保ってください。必要に応じて原語を括弧付きで残して構いません。",
    "prompt_user_intro": "以下のウェブコンテンツを読んで、以下を実行してください：",
    "prompt_paper_user_intro": "以下の内容を論文または論文紹介ページとして解説し、次の構成で出力してください：\n1）研究課題、動機、主要な貢献を 3-5 個の箇条書きで整理\n2）手法の要点を要約：モデル/アルゴリズム、主要モジュール、入出力、学習または推論の流れ\n3）実験の重要点を抽出：データセット、評価指標、比較対象、主な結果\n4）本文から明示的に読み取れる前提や限界を指摘\n5）ページが論文本文らしくない場合はその旨を明示し、与えられた情報だけで慎重に解釈\n6）最後に「精読する価値があるか」を短く述べ、3行以内で要約",
    "prompt_translate_user_intro": "以下のウェブページ内容を簡体字中国語に翻訳し、次の要件に従ってください：\n1）タイトルと本文の主要内容をできるだけ完全に翻訳する\n2）元の構成を保ち、読みやすい段落に整える\n3）専門用語、人名、略語は正確に扱い、必要なら原語を併記する\n4）内容が長すぎる場合は重要部分を完全翻訳し、それ以外は正確な圧縮翻訳であることを明示する\n5）追加の分析、要約、意見は加えない",
